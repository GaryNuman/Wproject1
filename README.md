...
For this book review website I used the Goodreads API
and a heroku database that I accessed using Adminer. 
set database URL before running the flask
The entire explanation of the extercise:
